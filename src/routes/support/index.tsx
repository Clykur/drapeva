...
const FAQS = [
  {
    ...
    a: "Our bridal lehengas and heavily embroidered sarees take between 4 to 6 weeks to weave and hand-finish. Ready-to-wear designs ship within 3 to 5 business days.",
  },
  {
        ...
        {activeTab === "policy" && (
          <div className="space-y-8 text-sm leading-relaxed text-muted-foreground">
            <div>
              ...
              <p>
                We provide worldwide shipping. Made-to-measure bridal orders require 4 to 6 weeks.
                Ready-to-wear orders ship in 3 to 5 business days. Once your item is dispatched, you
                will receive tracking numbers via SMS and email.
              </p>
            </div>
            <div>
