  ...
  head: () => ({
    meta: [
      { title: "Our Story — Maaya Couture" },
      {
        name: "description",
        content:
          "Learn about the heritage of Maaya Couture: handwoven silks, master weavers, and artisanal zardozi.",
      },
    ],
  }),
  component: AboutUs,
...
function AboutUs() {
  return (
    <div>
      {/* Hero */}
      <div className="relative h-[50svh] min-h-[350px] w-full bg-ink text-background flex items-center justify-center">
        <img
          src={p1}
      ...
      <div className="container-luxe py-20 space-y-24">
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              dedicated to restoring antique zardozi work and royal bridal lehengas. Today, we
              collaborate with over 250 master weavers across Banaras, Kanchipuram, and West Bengal
              to craft modern heirloom pieces.
            </p>
          </div>
          <div className="bg-champagne/20 border border-border p-6 shadow-soft">
            <img src={p4} alt="" className="w-full aspect-[4/3] object-cover" />
          </div>
        </div>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center md:flex-row-reverse">
          <div className="md:order-2 space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Every saree and lehenga is a calculation in patience. A single Katan silk weave takes
              up to three master weavers working in unison on a traditional handloom. Our zardozi is
              finished in our Juhu studio by fifth-generation artisans, using hand-twisted metallic
              threads and real fresh-water seed pearls.
            </p>
          </div>
          <div className="md:order-1 bg-champagne/20 border border-border p-6 shadow-soft">
            <img src={p1} alt="" className="w-full aspect-[4/3] object-cover" />
          </div>
        </div>
        ...
        <div className="bg-champagne/30 p-10 md:p-14 text-center max-w-3xl mx-auto border border-border">
          ...
          <blockquote className="mt-6 font-display text-xl md:text-2xl leading-relaxed italic">
            ...
            by bringing it directly to brides across the globe."
          </blockquote>
