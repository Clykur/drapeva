...
export const Route = createFileRoute("/collections/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Explore our curated edits of Banarasi sarees, custom lehengas and festive suits.",
      },
    ],
  }),
...
const COLLECTION_EDITS = [
  {
    ...
    desc: "Intricately detailed garments hand-finished with gold thread zardozi and real pearls for the luxury Indian bride.",
    image: p1,
  },
  {
    ...
    desc: "A tribute to Katan silk, real zari, and heirloom weaves direct from Varanasi and Kanchipuram master weavers.",
    image: p4,
  },
  {
    slug: "soiree",
    name: "Soirée Collection",
    tagline: "For the celebration",
    desc: "Fluid georgettes and shimmer crystal cut borders for modern evening receptions and festive ceremonies.",
    image: p3,
  },
];
    ...
    <div>
      ...
      <div className="container-luxe py-16 space-y-16">
        {COLLECTION_EDITS.map((col, index) => (
          <div
            key={col.slug}
            className={`grid gap-8 items-center md:grid-cols-2 ${index % 2 === 1 ? "md:flex-row-reverse" : ""}`}
          >
            <div
