...
export const Route = createFileRoute("/book-appointment")({
  head: () => ({
    meta: [
      { title: "Schedule Fitting & Consultation — Maaya Couture" },
      {
        name: "description",
        content:
          "Book a video bridal consultation or personal atelier visit with our master stylists.",
      },
    ],
  }),
    ...
    return (
      <div className="container-luxe py-24 text-center max-w-md">
        ...
        <p className="text-sm text-muted-foreground mt-4 leading-relaxed">
          ...
          will reach out to you via WhatsApp to finalize styling requirements.
        </p>
      ...
      <div className="border-b border-border bg-champagne/30">
        <div className="container-luxe py-14 md:py-20 text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-sm text-muted-foreground leading-relaxed">
            Schedule a session with our couturiers. Available via encrypted video call or physical
            studio visit in Mumbai.
          </p>
        </div>
      </div>
        ...
        >
          ...
          <label className="block">
            ...
            <textarea
              ...
              className="w-full border border-border bg-background px-4 py-2.5 text-sm focus:outline-none"
              placeholder="Let us know if you have specific collections, fabrics, or fit sketches in mind..."
            />
          </label>
