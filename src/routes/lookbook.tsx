...
export const Route = createFileRoute("/lookbook")({
  head: () => ({
    meta: [
      { title: "Lookbook — Maaya Couture" },
      {
        name: "description",
        content: "Explore our seasonal lookbook with masterfully styled couture edits.",
      },
    ],
  }),
    ...
    <div>
      ...
      <div className="container-luxe py-16 flex justify-center">
        <div className="relative w-full max-w-2xl aspect-[3/4] bg-champagne/20 border border-border shadow-soft overflow-hidden">
          <img src={p1} alt="Atelier photoshoot edit" className="w-full h-full object-cover" />
          ...
          {HOTSPOTS.map((hotspot) => (
            <button
              ...
              className="absolute z-20 grid h-8 w-8 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full bg-gold text-gold-foreground border-2 border-background animate-pulse transition-transform hover:scale-110"
          ...
          {activeHotspot && (
            <div className="absolute bottom-6 left-6 right-6 z-30 bg-background/95 border border-border p-4 shadow-soft backdrop-blur-md flex items-center gap-4 animate-rise">
              <img src={activeHotspot.product.image} alt="" className="h-20 w-15 object-cover" />
