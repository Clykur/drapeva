...
async function main() {
    ...
    const rawProducts = [
        {
            ...
            description: "An exquisite crimson red handwoven Kanjivaram silk saree adorned with delicate zardozi borders and hand-finished with gold thread motifs.",
            price: 84500,
            compareAt: 98000,
            fabric: "Kanjivaram",
            occasion: "Bridal",
        ...
        },
        {
            ...
            description: "Handwoven blush pink Banarasi silk with a 24k gold-tested zari border, designed in collaboration with master weavers from Varanasi.",
            price: 32400,
            compareAt: null,
            fabric: "Banarasi",
            occasion: "Reception",
        ...
        },
        {
            ...
            description: "An ethereal ivory white tissue organza saree featuring delicate gold thread embroidery and fresh-water pearl border details.",
            price: 28900,
            compareAt: null,
            fabric: "Organza",
            occasion: "Festive",
        ...
        },
        {
            ...
            description: "A regal emerald Kanjivaram woven in pure mulberry silk with a contrast gold border — heirloom craftsmanship from Tamil Nadu.",
            price: 56800,
            compareAt: 62000,
            fabric: "Silk",
            occasion: "Bridal",
    ...
    await prisma.supportTicket.create({
        data: {
            ...
            message: "Hello, I recently ordered the Noor Crimson Bridal Kanjivaram Saree and would love to customize the sleeve length. How can I submit my exact measurements?",
            status: "OPEN",
            priority: "HIGH",
        },
    });
    ...
    await prisma.review.create({
        data: {
            ...
            comment: "The hand zardozi work is absolutely outstanding. Fits like a glove. Worth every single penny and more.",
            isApproved: true,
        },
    });
