  ...
  public: {
    Tables: {
      profiles: {
        ...
        Insert: Omit<
          Profile,
          "created_at" | "updated_at" | "name" | "phone" | "avatar_url" | "role"
        > &
          Partial<Pick<Profile, "name" | "phone" | "avatar_url" | "role">>;
      ...
      categories: {
        ...
        Insert: Omit<
          Category,
          "id" | "created_at" | "description" | "image" | "sort_order" | "is_active"
        > &
          Partial<Pick<Category, "description" | "image" | "sort_order" | "is_active">>;
      ...
      collections: {
        ...
        > &
          Partial<
            Pick<
              Collection,
              "tagline" | "description" | "image" | "is_featured" | "sort_order" | "is_active"
            >
          >;
      ...
      reviews: {
        ...
        > &
          Partial<
            Pick<
              Review,
              "reviewer_name" | "reviewer_email" | "title" | "comment" | "is_approved" | "user_id"
            >
          >;
...
export type MakeDatabaseCompat<T> = T extends {
  public: {
    Tables: infer Tab;
    Views: infer V;
    Functions: infer F;
  ...
  ? {
      public: {
        Tables: {
          [K in keyof Tab]: {
            Row: Tab[K] extends { Row: infer R }
              ? { [P in keyof R]: R[P] } & Record<string, unknown>
              : any;
            Insert: Tab[K] extends { Insert: infer I }
              ? { [P in keyof I]: I[P] } & Record<string, unknown>
              : any;
            Update: Tab[K] extends { Update: infer U }
              ? { [P in keyof U]: U[P] } & Record<string, unknown>
              : any;
            Relationships: [];
          };
        };
