      ...
      <div className="container-luxe py-24 md:py-32 space-y-24 md:space-y-32">
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          <div className="space-y-4">
            ...
            <h2 className="font-display text-3xl md:text-4xl">Where Comfort Meets Elegance</h2>

            <p className="text-sm text-muted-foreground leading-relaxed">
              Drapeva is an online destination for women seeking elegant, comfortable, and timeless
              sarees. We bring together carefully selected collections from trusted brands and
              sellers, making it easier to discover styles that suit every occasion.
            </p>
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          <div className="md:order-2 space-y-4">
            ...
            <h2 className="font-display text-3xl md:text-4xl">Style, Comfort & Confidence</h2>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Whether you're shopping for a special event or updating your wardrobe, our collections
              are curated to help you find the perfect drape with confidence.
            </p>
          </div>
