...
import { t as createMiddleware } from "./createStart-CmdQdnZF.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DX9q9B2y.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-l9GV9mzG.mjs"),
		import("./start-DvMPuK3p.mjs"),
